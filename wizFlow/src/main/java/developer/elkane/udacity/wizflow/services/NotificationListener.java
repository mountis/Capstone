...
package developer.elkane.udacity.wizflow.services;
...
import developer.elkane.udacity.wizflow.async.bus.NotificationRemovedEvent;
...
public class NotificationListener extends NotificationListenerService {
    ...
    public static boolean isRunning() {
        ...
        ContentResolver contentResolver = WizFlow.getAppContext().getContentResolver();
