...
import developer.elkane.udacity.wizflow.async.DataBackupIntentService;
...
import developer.elkane.udacity.wizflow.utils.ResourcesUtils;
...
public class SettingsFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null && getArguments().containsKey(XML_NAME)) {
            xmlId = ResourcesUtils.getXmlId(WizFlow.getAppContext(), ResourcesUtils.ResourceIdentifiers.xml, String
                ...
                new MaterialDialog.Builder(getActivity())
                        ...
                        .callback(new MaterialDialog.ButtonCallback() {
                            ...
                            public void onPositive(MaterialDialog materialDialog) {
                                ...
                                ((WizFlow) getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING, "settings_tour_show_again");
                    ...
                    new MaterialDialog.Builder(getActivity())
                            ...
                            .callback(new MaterialDialog.ButtonCallback() {
                                ...
                                public void onPositive(MaterialDialog materialDialog) {
                                    ...
                                    ((WizFlow) getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING,
    ...
    private void export(View v) {
        ...
        new MaterialDialog.Builder(getActivity())
                ...
                .callback(new MaterialDialog.ButtonCallback() {
                    @Override
                    public void onPositive(MaterialDialog materialDialog) {
                        ((WizFlow) getActivity().getApplication()).getAnalyticsHelper().trackEvent(AnalyticsHelper.CATEGORIES.SETTING, "settings_export_data");
